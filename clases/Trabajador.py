...
class Trabajador:
    ...
    def write_df(self, df_mov):
        ...
        # new_row = {{self.id},{self.fechaAlta},{self.puesto},{self.categoria},{self.horarioTrabajo}}
        new_row = {}
    ...
    @classmethod
    def ConvertirATrabajadores(cls,df_mov):
        ...
        for index, row in df_mov.iterrows():
            ...
            trabajador = Trabajador(puesto, categoria, horarioTrabajo, fechaAlta, id=row['id'])
