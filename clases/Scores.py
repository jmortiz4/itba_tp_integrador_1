...
class Scores:
    ...
    def __repr__(self):
        ...
        return f'\n [{self.idPelicula}] [{self.idUsuario}] - Califico: ({self.puntuacion}) en: -{self.timestamp}-'
    ...
    def get_stats(cls,df_mov, anios=None, generos=None):
        # - Scores: Puntuación promedio de usuario(s) por año(de película)/género. 
        # - Puntuación promedio de películas por género de usuario(sexo)/rango etáreo/Ocupación.
